...
export const alerts = {
  ...
  "alert_loginBadValueEnter":
    <p style={{textAlign:'center'}}>Регистрационные данные введены не корректно.<br/>Повторите попытку или обратитесь в службу поддержки.</p>,

  "alert_loginBadValueReg":
    <p style={{textAlign:'center'}}>Не верные данные для регистрации.<br/>Повторите попытку или обратитесь в службу поддержки.</p>
